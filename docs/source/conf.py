...
Copyright
    ...
    valagen is distributed in the hope that it will be useful, but
...
version: str = '2.0'
release: str = 'https://github.com/vroncevic/valagen/releases'
...
htmlhelp_basename: str = 'valagendoc'
latex_elements: Dict[Any, Any] = {}
latex_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'valagen.tex', 'valagen Documentation',
    'Vladimir Roncevic \\textless{}elektron.ronca@gmail.com\\textgreater{}',
    'manual'
)]
man_pages: List[Tuple[Any, ...]] = [(
    master_doc, 'valagen', 'valagen Documentation', [author], 1
)]
texinfo_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'valagen', 'valagen Documentation', author, 'valagen',
